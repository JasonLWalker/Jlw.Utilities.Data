...
namespace Jlw.Utilities.Data.DbUtility
{
    public interface IModularDbClient
    {
        ...
        IEnumerable<TReturn> GetRecordList<TInterface, TModel, TReturn>(TInterface o, string connString, RepositoryMethodDefinition<TInterface, TModel> definition) where TModel : TInterface;
    }
