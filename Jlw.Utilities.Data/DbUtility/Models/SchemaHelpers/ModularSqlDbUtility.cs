...
{
    public class ModularSqlDbUtility : ModularBaseDbUtility<ModularSqlClient, object, object>
    {
...
//        protected override IModularDbClient DbClient { get; } = new ModularDbClient<SqlConnection, SqlCommand, SqlParameter>();
        protected new SqlConnectionStringBuilder _builder = new SqlConnectionStringBuilder();
        public new SqlConnectionStringBuilder ConnectionStringBuilder => _builder;

        public ModularSqlDbUtility() : this(null) {}


        public ModularSqlDbUtility(string connString) : base("TSQL", connString, new ModularSqlClient())
        {
        ...
        {
            SqlConnectionStringBuilder builder = new SqlConnectionStringBuilder(ConnectionStringBuilder.ConnectionString);
