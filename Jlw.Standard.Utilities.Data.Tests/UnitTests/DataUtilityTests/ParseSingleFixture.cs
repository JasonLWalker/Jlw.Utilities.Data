...
namespace Jlw.Standard.Utilities.Data.Tests.UnitTests
{
    ...
    public class ParseSingleFixture
    {
        ...
        {
            Assert.AreEqual(expectedValue, DataUtility.ParseSingle(Jlw.Standard.Utilities.Data.Tests.DataSourceValues.NullableSingleKvpList, key));
            Assert.AreEqual(expectedValue, DataUtility.ParseFloat(Jlw.Standard.Utilities.Data.Tests.DataSourceValues.NullableSingleKvpList, key));
        }
        ...
        {
            Assert.AreEqual(expectedValue, DataUtility.ParseSingle(Jlw.Standard.Utilities.Data.Tests.DataSourceValues.NullableSingleDictionary, key));
            Assert.AreEqual(expectedValue, DataUtility.ParseFloat(Jlw.Standard.Utilities.Data.Tests.DataSourceValues.NullableSingleDictionary, key));
        }
        ...
        {
            Assert.AreEqual(expectedValue, DataUtility.ParseSingle(Jlw.Standard.Utilities.Data.Tests.DataSourceValues.NullableSingleDataRecord, key));
            Assert.AreEqual(expectedValue, DataUtility.ParseFloat(Jlw.Standard.Utilities.Data.Tests.DataSourceValues.NullableSingleDataRecord, key));
        }
