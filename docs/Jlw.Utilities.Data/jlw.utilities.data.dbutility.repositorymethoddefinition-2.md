...
# RepositoryMethodDefinition&lt;TInterface, TModel&gt;
...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [RepositoryMethodDefinition&lt;TInterface, TModel&gt;](./jlw.utilities.data.dbutility.repositorymethoddefinition-2.md)<br>
...
### **RepositoryMethodDefinition(String, IEnumerable&lt;KeyValuePair&lt;String, Object&gt;&gt;, RepositoryRecordCallback, Type)**

```csharp
public RepositoryMethodDefinition(string sql, IEnumerable<KeyValuePair<string, object>> paramList, RepositoryRecordCallback callback, Type returnType)
```
...
### **RepositoryMethodDefinition(String, IEnumerable&lt;IDbDataParameter&gt;, RepositoryRecordCallback, Type)**

```csharp
public RepositoryMethodDefinition(string sql, IEnumerable<IDbDataParameter> paramList, RepositoryRecordCallback callback, Type returnType)
```
...
### **RepositoryMethodDefinition(String, CommandType, IEnumerable&lt;IDbDataParameter&gt;, RepositoryRecordCallback, Type)**

```csharp
public RepositoryMethodDefinition(string sql, CommandType cmdType, IEnumerable<IDbDataParameter> paramList, RepositoryRecordCallback callback, Type returnType)
```
...
### **RepositoryMethodDefinition(String, CommandType, IEnumerable&lt;KeyValuePair&lt;String, Object&gt;&gt;, RepositoryRecordCallback, Type)**

```csharp
public RepositoryMethodDefinition(string sql, CommandType cmdType, IEnumerable<KeyValuePair<string, object>> paramList, RepositoryRecordCallback callback, Type returnType)
```
