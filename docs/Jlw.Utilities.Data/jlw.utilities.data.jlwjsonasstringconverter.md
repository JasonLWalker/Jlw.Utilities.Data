...
```csharp
public class JlwJsonAsStringConverter : Newtonsoft.Json.JsonConverter
```

Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → JsonConverter → [JlwJsonAsStringConverter](./jlw.utilities.data.jlwjsonasstringconverter.md)
