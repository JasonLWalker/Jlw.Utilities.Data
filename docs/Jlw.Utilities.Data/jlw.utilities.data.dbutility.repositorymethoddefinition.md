...
# RepositoryMethodDefinition

Namespace: Jlw.Utilities.Data.DbUtility

```csharp
public class RepositoryMethodDefinition : RepositoryMethodDefinition`2, IRepositoryMethodDefinition
```

Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [RepositoryMethodDefinition&lt;Object, Object&gt;](./jlw.utilities.data.dbutility.repositorymethoddefinition-2.md) → [RepositoryMethodDefinition](./jlw.utilities.data.dbutility.repositorymethoddefinition.md)<br>
