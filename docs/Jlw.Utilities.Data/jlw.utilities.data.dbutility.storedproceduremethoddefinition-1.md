...
# StoredProcedureMethodDefinition&lt;TModel&gt;

Namespace: Jlw.Utilities.Data.DbUtility

```csharp
public class StoredProcedureMethodDefinition<TModel> : RepositoryMethodDefinition`2, IRepositoryMethodDefinition
```
...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → RepositoryMethodDefinition&lt;TModel, TModel&gt; → [StoredProcedureMethodDefinition&lt;TModel&gt;](./jlw.utilities.data.dbutility.storedproceduremethoddefinition-1.md)<br>
