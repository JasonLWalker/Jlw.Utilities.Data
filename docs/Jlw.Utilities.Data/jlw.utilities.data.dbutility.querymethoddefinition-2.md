...
# QueryMethodDefinition&lt;TInterface, TModel&gt;

Namespace: Jlw.Utilities.Data.DbUtility

```csharp
public class QueryMethodDefinition<TInterface, TModel> : RepositoryMethodDefinition`2, IRepositoryMethodDefinition
```
...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → RepositoryMethodDefinition&lt;TInterface, TModel&gt; → [QueryMethodDefinition&lt;TInterface, TModel&gt;](./jlw.utilities.data.dbutility.querymethoddefinition-2.md)<br>
