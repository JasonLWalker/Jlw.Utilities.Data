...
```csharp
public class JlwJsonConverter<T> : Newtonsoft.Json.JsonConverter
```
...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → JsonConverter → [JlwJsonConverter&lt;T&gt;](./jlw.utilities.data.jlwjsonconverter-1.md)
