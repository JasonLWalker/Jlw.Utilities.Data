...
namespace Jlw.Utilities.Data.Tests.IntegrationTests.ModularDbClient.TInstance_TModel
{
    ...
    public class GetRecordObject_definition_withcallback : SqlLocalDbInstanceFixtureBase<ModularDataRepository<ITestDataModel, TestDataModel>>
    {
        ...
        public void Should_Succeed_ForSqlQuery_StringArray()
        {
            ...
            var definition = new RepositoryMethodDefinition<ITestDataModel, TestDataModel>("SELECT TOP 1 * FROM TestTable WHERE Id = @id", new string[] { "Id" }, RecordCallback);
        ...
        public void Should_Succeed_ForSqlQuery_Kvp()
        {
            // Arrange
            base.InitializeInstanceData(SqlInitFilename);
            var definition = new RepositoryMethodDefinition<ITestDataModel, TestDataModel>("SELECT TOP 1 * FROM TestTable WHERE Name = @name AND Id=@id", new [] { new KeyValuePair<string, object>("Id", 1),  new KeyValuePair<string, object>("Name", "Test User") }, RecordCallback);
        ...
        public void Should_Succeed_ForStoredProcedure_StringArray()
        {
            // Arrange
            base.InitializeInstanceData(SqlInitFilename);
            var definition = new RepositoryMethodDefinition<ITestDataModel, TestDataModel>("sp_GetRecordData", CommandType.StoredProcedure, new string[] { "Id" }, RecordCallback);
        ...
        {
            // Arrange
            var definition = new RepositoryMethodDefinition<ITestDataModel, TestDataModel>("", new string[] { "Id" }, RecordCallback);
        ...
        {
            // Arrange
            var definition = new RepositoryMethodDefinition<ITestDataModel, TestDataModel>("", CommandType.StoredProcedure, new string[] { "Id" }, RecordCallback);
        ...
        {
            // Arrange
            var definition = new RepositoryMethodDefinition<ITestDataModel, TestDataModel>("sp_GetRecord", CommandType.StoredProcedure, new string[] { "Id" }, RecordCallback);
