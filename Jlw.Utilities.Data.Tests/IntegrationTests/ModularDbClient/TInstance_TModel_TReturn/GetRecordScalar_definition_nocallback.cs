...
namespace Jlw.Utilities.Data.Tests.IntegrationTests.ModularDbClient.TInstance_TModel_TReturn
{
    ...
    public class GetRecordScalar_definition_nocallback : SqlLocalDbInstanceFixtureBase<ModularDataRepository<ITestDataModel, TestDataModel>>
    {
        ...
        public void Should_Succeed_ForSqlQuery_StringArray()
        {
            ...
            var definition = new RepositoryMethodDefinition<ITestDataModel, TestDataModel>("SELECT * FROM TestTable WHERE Name = @name AND Id=@id", new[] { "Id", "Name" });//DbClient.BuildRepositoryMethodDefinition<ITestDataModel, TestDataModel>(, false);
        ...
        public void Should_Succeed_ForStoredProcedure_StringArray()
        {
            // Arrange
            base.InitializeInstanceData(SqlInitFilename);
            var definition = new RepositoryMethodDefinition<ITestDataModel, TestDataModel>("sp_GetRecordData", CommandType.StoredProcedure, new[] { "Id" });//DbClient.BuildRepositoryMethodDefinition<ITestDataModel, TestDataModel>("sp_GetRecordData", new []{"Id"}, true);
