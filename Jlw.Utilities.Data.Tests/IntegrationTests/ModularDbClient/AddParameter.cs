...
namespace Jlw.Utilities.Data.Tests.IntegrationTests.ModularDbClient
{
    ...
    public class AddParameter : BaseModelFixture<ModularDbClient<SqlConnection>>
    {
        ...
        public void Should_Match_ForNullDbCommand()
        {
            ...
            var p1 = MockClient1.AddParameter(MockParam1, cmd1);
            AssertParamsMatch1(p1, Param1);

            var p2 = MockClient2.AddParameter(MockParam2, cmd2);
            AssertParamsMatch1(p2, Param2);

            var p3 = MockClient3.AddParameter(MockParam3, cmd3);
            AssertParamsMatch1(p3, Param3);

            var p4 = MockClient4.AddParameter(MockParam4, cmd4);
        ...
        public void Should_Match_ForSQLiteCommand()
        {
            ...
            var p1 = SQLiteClient1.AddParameter(SQLiteParam1, cmd1);
            AssertParamsMatch1(p1, SQLiteParam1);

            var p2 = SQLiteClient2.AddParameter(SQLiteParam2, cmd2);
            AssertParamsMatch1(p2, SQLiteParam2);

            var p3 = SQLiteClient3.AddParameter(SQLiteParam3, cmd3);
            AssertParamsMatch1(p3, SQLiteParam3);

            var p4 = SQLiteClient4.AddParameter(SQLiteParam4, cmd4);
        ...
        public void Should_Match_ForSqlCommand()
        {
            ...
            var p1 = SqlClient1.AddParameter(SqlParam1, cmd1);
            AssertParamsMatch1(p1, SqlParam1);

            var p2 = SqlClient2.AddParameter(SqlParam2, cmd2);
            AssertParamsMatch1(p2, SqlParam2);

            var p3 = SqlClient3.AddParameter(SqlParam3, cmd3);
            AssertParamsMatch1(p3, SqlParam3);

            var p4 = SqlClient4.AddParameter(SqlParam4, cmd4);
        ...
        public void Should_Match_ForMySqlCommand()
        {
            ...
            var p1 = MySqlClient1.AddParameter(MySqlParam1, cmd1);
            AssertParamsMatch1(p1, MySqlParam1);

            var p2 = MySqlClient2.AddParameter(MySqlParam2, cmd2);
            AssertParamsMatch1(p2, MySqlParam2);

            var p3 = MySqlClient3.AddParameter(MySqlParam3, cmd3);
            AssertParamsMatch1(p3, MySqlParam3);

            var p4 = MySqlClient4.AddParameter(MySqlParam4, cmd4);
