...
namespace Jlw.Utilities.Data.Tests.UnitTests.DataUtilityStatic
{
    ...
    public class ParseNullableSingleFixture
    {
        ...
        {
            Assert.AreEqual(expectedValue, DataUtility.ParseNullableSingle(Jlw.Utilities.Data.Tests.DataSourceValues.NullableSingleKvpList, key));
            Assert.AreEqual(expectedValue, DataUtility.ParseNullableFloat(Jlw.Utilities.Data.Tests.DataSourceValues.NullableSingleKvpList, key));
        }
        ...
        {
            Assert.AreEqual(expectedValue, DataUtility.ParseNullableSingle(Jlw.Utilities.Data.Tests.DataSourceValues.NullableSingleDictionary, key));
            Assert.AreEqual(expectedValue, DataUtility.ParseNullableFloat(Jlw.Utilities.Data.Tests.DataSourceValues.NullableSingleDictionary, key));
        }
        ...
        {
            Assert.AreEqual(expectedValue, DataUtility.ParseNullableSingle(Jlw.Utilities.Data.Tests.DataSourceValues.NullableSingleDataRecord, key));
            Assert.AreEqual(expectedValue, DataUtility.ParseNullableFloat(Jlw.Utilities.Data.Tests.DataSourceValues.NullableSingleDataRecord, key));
        }
