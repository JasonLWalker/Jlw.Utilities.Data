...
namespace Jlw.Utilities.Data.Tests.UnitTests.DataUtilityStatic
{
    ...
    public class ParseSByteFixture
    {
        ...
        {
            Assert.AreEqual(expectedValue, DataUtility.ParseSByte(Jlw.Utilities.Data.Tests.DataSourceValues.NullableSByteKvpList, key));
        }
        ...
        {
            Assert.AreEqual(expectedValue, DataUtility.ParseSByte(Jlw.Utilities.Data.Tests.DataSourceValues.NullableSByteDictionary, key));
        }
        ...
        {
            Assert.AreEqual(expectedValue, DataUtility.ParseSByte(Jlw.Utilities.Data.Tests.DataSourceValues.NullableSByteDataRecord, key));
        }
